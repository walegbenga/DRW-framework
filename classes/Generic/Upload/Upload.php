...
class Upload
{
	...
	public function getAssignedFilename(){
		return $this->assignedFilename;
	}
    ...
    protected function checkName($file, $renameDuplicates) {
		...
		$this->newName = sha1($file['name'] . uniqid('',true));
    ...
    protected function moveFile($file) {
        ...
        if ($success) {
			...
			$this->assignedFilename[] = $this->newName;
        } else {
